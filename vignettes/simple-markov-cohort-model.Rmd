...
# Model settings
Define initial distribution over the 4 health states
```{r, message=FALSE}
...
Define the transition matrix with monotherapy
```{r, message=FALSE}
...
Define the relative treatment effect with combination therapy relative to monotherapy
```{r, message=FALSE}
RR<-0.509
```
...
Incremental cost-effectiveness ratio (ICER) in terms costs per life years with combination therapy relative to monotherapy
```{r, message=FALSE}
