...
Health state occupancy, discounted life years and discounted costs with combination therapy for a time-horizon of 20 years. Combination therapy is only provided for 2 years
```{r, message=FALSE}
